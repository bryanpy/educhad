...
responses = [
    ...
    {'reply':["Yes,I am doing fine"],'requirements':['are'],'must':['you?'],'hasArg':True,'probability':0},
    ...
    {'reply':[q.louisXVI],'requirements':[],'must':['louis'],'hasArg':True,'imageurl':'https://www.onthisday.com/images/people/louis-xvi.jpg?w=360','probability':0},
    ...
    {'reply':[q.fatherofchem],'requirements':['father','of'],'must':['chemistry'],'hasArg':True,'imageurl':'https://s3-ap-southeast-1.amazonaws.com/sawaal.com/qaimg/who_is_the_father_of_modern_chemistry1538547478.jpg','probability':0},
    ...
    {'reply':[q.wet],'requirements':[],'must':['work','energy','theorem'],'hasArg':True,'probability':0,'vidurl':'https://www.youtube.com/watch?v=nnMirzeTepQ'},
